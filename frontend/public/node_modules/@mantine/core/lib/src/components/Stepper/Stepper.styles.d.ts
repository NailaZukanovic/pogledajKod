...
declare const _default: (params: StepperStyles, options?: import("@mantine/styles/lib/tss/create-styles").UseStylesOptions<"content" | "separator" | "root" | "steps" | "separatorActive">) => {
