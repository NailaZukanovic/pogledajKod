...
export interface ColProps extends Omit<DefaultProps, MantineMargin>, React.ComponentPropsWithoutRef<'div'> {
    /** Default col span */
    span: number;
...
export declare function Col({ children, span, gutter, offset, offsetXs, offsetSm, offsetMd, offsetLg, offsetXl, grow, xs, sm, md, lg, xl, columns, className, id, sx, ...others }: ColProps): JSX.Element;
