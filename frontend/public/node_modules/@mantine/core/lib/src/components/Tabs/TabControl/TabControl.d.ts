...
export declare function TabControl({ className, active, buttonRef, tabProps, color, variant, classNames, styles, orientation, icon: __, sx, ...others }: TabControlProps): JSX.Element;
