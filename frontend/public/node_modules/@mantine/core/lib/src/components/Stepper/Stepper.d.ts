...
import { MantineColor, DefaultProps, MantineNumberSize, MantineSize, ClassNames } from '@mantine/styles';
import { Step, StepStylesNames } from './Step/Step';
import useStyles from './Stepper.styles';
export declare type StepperStylesNames = ClassNames<typeof useStyles> | StepStylesNames;
