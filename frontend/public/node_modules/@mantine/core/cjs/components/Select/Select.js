...
var groupSortData = require('./group-sort-data/group-sort-data.js');
...
const Select = React.forwardRef((_a, ref) => {
  ...
  const [creatableDataValue, setCreatableDataValue] = React.useState(void 0);
  ...
  hooks.useClickOutside(() => setDropdownOpened(false), ["mousedown", "touchstart"], [inputRef.current, dropdownRef.current]);
