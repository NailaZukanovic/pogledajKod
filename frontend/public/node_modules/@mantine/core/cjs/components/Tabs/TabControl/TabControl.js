...
function TabControl(_a) {
  ...
  const { classes, cx } = TabControl_styles['default']({ color: overrideColor || color, orientation }, { classNames, styles: styles$1, name: "Tabs" });
  return /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues(__spreadValues({}, others), props), {
    tabIndex: active ? 0 : -1,
    className: cx(classes.tabControl, classes[variant], { [classes.tabActive]: active }, sxClassName, className),
    type: "button",
    role: "tab",
