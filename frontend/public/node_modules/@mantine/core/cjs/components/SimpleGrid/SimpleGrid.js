...
const SimpleGrid = React.forwardRef((_a, ref) => {
  var _b = _a, {
    className,
    breakpoints = [],
    cols = 1,
  ...
  const sortedBreakpoints = getSortedBreakpoints.getSortedBreakpoints(theme, breakpoints);
  const { classes, cx } = SimpleGrid_styles['default']({ breakpoints: sortedBreakpoints, cols, spacing }, { sx, name: "SimpleGrid" });
