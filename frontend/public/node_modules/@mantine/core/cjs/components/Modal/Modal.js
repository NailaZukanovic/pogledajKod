...
function MantineModal(_a) {
  ...
  const { classes, cx, theme } = Modal_styles['default']({ size, overflow }, { sx, classNames, styles, name: "Modal" });
  ...
  return /* @__PURE__ */ React__default.createElement(GroupedTransition.GroupedTransition, {
    ...
    ref: focusTrapRef
  }, closeOnClickOutside && /* @__PURE__ */ React__default.createElement("div", {
    onClick: onClose,
