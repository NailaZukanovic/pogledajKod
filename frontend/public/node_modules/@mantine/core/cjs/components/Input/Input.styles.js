...
var useStyles = styles.createStyles((theme, { size, multiline, radius, variant, invalid, disabled }) => {
  ...
  return {
    ...
    input: variant === "headless" ? {} : __spreadValues(__spreadProps(__spreadValues(__spreadValues(__spreadProps(__spreadValues(__spreadValues({}, theme.fn.fontStyles()), getVariantStyles({ variant, theme })), {
