...
import { useMantineTheme, useExtractedMargins, getSharedColorScheme } from '@mantine/styles';
...
const ActionIcon = forwardRef((_a, ref) => {
  ...
  const { classes, cx } = useStyles({ size, radius, color }, { name: "ActionIcon", classNames, styles, sx });
