...
import { useUuid, useScrollIntoView, useClickOutside, useUncontrolled, useDidUpdate, useMergedRef } from '@mantine/hooks';
...
const Select = forwardRef((_a, ref) => {
  ...
  useClickOutside(() => setDropdownOpened(false), ["mousedown", "touchstart"], [inputRef.current, dropdownRef.current]);
